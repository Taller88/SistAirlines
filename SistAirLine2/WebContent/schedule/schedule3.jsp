...
function goOneWayController(){
	   var frm=document.seatfrm;
		frm.work_div.value="doOneWay";
		frm.work_div.action="/SistAirLine/seatDTO/seats.do";
		frm.submit();
}
function goRoundWayController(){
	   var frm=document.seatfrm;
		frm.work_div.value="doRoundTrip";
		frm.work_div.action="/SistAirLine/seatDTO/seat.do";
		frm.submit();
}
</script>
	...
	<div class="home_search">
		<div class="container">
			<div class="row">
				...
				<form action="/SistAirLine/seats/seat.do" name="seatfrm" id="seatfrm" method="post">
