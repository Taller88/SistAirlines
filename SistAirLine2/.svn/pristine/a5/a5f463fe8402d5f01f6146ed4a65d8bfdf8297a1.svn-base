			...
			<div class="row">
				<div class="col">
					<div class="home_search_container">
						...
						<div id="div_sche" >
							<span style="color:white;">예약 내용조회</span>
						</div>
                        ...
                        <input type="hidden" id="resPassport" name="resPassport"/>
					       ...
					       <table id="div_sche">
                             ...
                             <c:forEach var="i" begin="0" end="${list.size()-1}"> <!-- list : 인천 있을때 오는거 (왕복) -->
                                <tr>
                                    <td><c:out value="${list.get(i).resNum }"></c:out> </td>
                                    <td><c:out value="${list.get(i).resEname }"></c:out> </td>
                                    <td class="acenter"><c:out value="${scList.get(i).scDate }"></c:out> </td>
                                    <td class="acenter"><c:out value="${scList.get(i).scAcity }"></c:out> </td>
                                    <td class="acenter"><c:out value="${scList.get(i).scDcity }"></c:out> </td>
                                    <td class="acenter"><c:out value="${scList.get(i).scDtime }"></c:out> </td>
                                    <td class="acenter">
...
<script type="text/javascript">
	...
	$("#div_sche>tbody").on("click","tr",function(event){
        console.log("event:"+event);
        console.log("#div_sche>tbody>tr");
        var pTR = $(this);//tr
        ...
        alert(resNum+" 해당 예약번호로 조회합니다.");
        frm.work_div.value = "do_member_retrieve";
