       ...
       var frm=document.schedule_frm;
		...
		frm.submit();
				...
				//	   goRetrieve();
			       ...
			       var inDateOne=$("#inDateAr").val();
			       if(inDateOne==null ||outDateAr.trim().length==0){
			           alert('도착날짜를 확인하세요');
			           $("#inDateAr").focus();
			           return;
...
//           dataType:"html",
//           data:{"work_div":"do_retrieve",
//               "dCityOne":$("#dCityOne").val(),
//               "aCityOne":$("#aCityOne").val(),
//               "outDateOne":$("#outDateOne").val()
//               
//           },
...
function goRetrieve(){
	console.log('goRe');
   window.location.href='/SistAirLine/scheduleDTO/schedule.do?work_div=do_retrieve';
}
				...
				<div class="col">
					<div class="home_search_container">
						...
						<div class="home_search_content">
						 		<form action="/SistAirLine/scheduleDTO/schedule.do" method="get" name="schedule_frm">
								...
								<div style="padding-bottom:20px">
									...
									<label><input type="radio" name="trip-type" id="radioMuti"  value="3" onclick="scnOnOff(this.value,con3)"/> 다구간</label>
								</div>
								<div id="con1" style="display:none;"> <!-- 편도 display -->
									<div class="d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start" style="padding-bottom:20px" >
										<input type="text" name="dCityOne" id="dCityOne" class="search_input search_input_1" id="pDInputOne" placeholder="출발지" required="required" style="height: 40px; width: 300px;">
										<img src="img\pin1.png" id="btnDCity" onclick="openDCityFormOne()" style="height: 40px; width: 40px;">
										<input type="text" name="aCityOne" id="aCityOne" class="search_input search_input_1" id="pAInputOne" placeholder="도착지" required="required" style="height: 40px; width: 300px;">
										<img src="img\pin1.png" id="btnACity" onclick="openACityFormOne()" style="height: 40px; width: 40px;">
										<input type="text" name="outDateOne" id="outDateOne" class="search_input search_input_1" id="dateOne" placeholder="출발일 (YYYY-MM-DD)" required="required" style="height: 40px; width: 300px;">
										<img src="img\calendar.png" id="btnACity" onclick="" style="height: 45px; width: 45px; padding:5px;">
									</div>
								</div>
								<div id="con2"><!-- 왕복 display -->
									<div class="d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start" style="padding-bottom:20px">
										<input type="text" name="dCityAr" id="dCityAr" class="search_input search_input_1" id="pDInputAround" placeholder="출발지" required="required" style="height: 40px; width: 300px;">
										<img src="img\pin1.png" id="btnDCity" onclick="openDCityFormAround()" style="height: 40px; width: 40px;">
										<input type="text" name="aCityAr" id="aCityAr" class="search_input search_input_2" id="pAInputAround" placeholder="도착지" required="required" style="height: 40px; width: 300px;">
										<img src="img\pin1.png" id="btnACity" onclick="openACityFormAround()" style="height: 40px; width: 40px;">
										<input type="text" name="outDateAr" id="outDateAr" class="search_input search_input_3" id="dateA1" placeholder="가는 날" required="required" style="height: 40px; width: 140px;">
										<input type="text" name="inDateAr"  id="inDateAr" class="search_input search_input_3" id="dateA2" placeholder="오는 날 " required="required" style="height: 40px; width: 140px; padding-left:20px;">
										<img src="img\calendar.png" id="btnACity" onclick="" style="height: 45px; width: 45px; padding:5px;">
								...
								<div class="d-flex flex-lg-row flex-column align-items-start justify-content-lg-between justify-content-start" style="padding-bottom:20px">
									<img src="img\minus.png" id="btnAminus" onclick="" style="height: 45px; width: 45px; padding:5px;">
									<input type="text" class="search_input search_input_1" id="inputAdult" name="inputAdult" value="1" style="height: 40px; width: 200px; text-align:center;">
									<img src="img\plus.png" id="btnAplus" onclick="" style="height: 45px; width: 45px; padding:5px;">
									<img src="img\minus.png" id="btnCminus" onclick="" style="height: 45px; width: 45px; padding:5px;">
									<input type="text" class="search_input search_input_2" id="inputChild" name="inputChild" value="0" style="height: 40px; width: 200px; text-align:center;">
									<img src="img\plus.png" id="btnCplus" onclick="" style="height: 45px; width: 45px; padding:5px;">
									<img src="img\minus.png" id="btnTminus" onclick="" style="height: 45px; width: 45px; padding:5px;">
									<input type="text" class="search_input search_input_3" id="inputTodd" name="inputTodd" value="0" style="height: 40px; width: 200px; text-align:center;">
									<img src="img\plus.png" id="btnTplus" onclick="" style="height: 45px; width: 45px; padding:5px;">
